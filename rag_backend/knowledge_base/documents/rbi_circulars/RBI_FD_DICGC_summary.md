...
- **Worked example (multi-bank):** If you hold ₹4,00,000 in Bank A, ₹4,00,000 in Bank B, ₹4,00,000 in Bank C, and ₹4,00,000 in Bank D, each bank is a separate insured entity — each ₹4L bucket is within the ₹5L cap, so all four are fully covered (principal + accrued interest combined per bank, each capped at ₹5L).
...
- **Worked example (TDS threshold vs ITR):** ₹3,00,000 principal at **7.5% p.a. simple interest for 1 year** → gross interest **₹22,500**. Because ₹22,500 is **below the ₹40,000** Section 194A TDS threshold for non-seniors at a single bank, **the bank does not deduct TDS** on this interest (assuming PAN furnished and no other FD interest from the same bank pushes you over ₹40,000 in that FY). Separately, if your **total taxable income** including this ₹22,500 still falls in the **30% slab**, you may owe **₹6,750** (30% of ₹22,500) as **regular income-tax on interest income when you file your ITR** — TDS and final ITR liability are different layers.
